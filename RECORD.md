...
updated_at: "2026-09-22T22:23:04-06:00"
record_status: open
work_status: active
---
...
David ratified at 2026-09-23T02:32:38Z (20:32:38 -06:00 on 2026-09-22). It stops at its return.

Work owner: Moss (coordinator), acting as the worker-U4 subagent for U17 only.

Claimed by: Moss (worker-U4 subagent), for U17 only, since "2026-09-22T22:23:04-06:00"
(2026-09-23T04:23:04Z).
...
Work: revision 38 registers U17's claim, grant card, pickup plan and disposition rule, before any
run.

Outcome: none yet for U17. At revision 38 no run of U17 has happened.

Next: Moss — run the offline half as the U17 pickup plan in Act states, and record it here.

Further pending: David, to choose when the live half runs (option A, on or after 2026-09-28, or B,
now), in the tools-as-skills record's "U4's targets".

Blocked: the live half only, for want of David's timing choice. The offline half is not blocked.
...
| **U17** (active, offline half only; live half held) | **Re-measure the false-positive rate on the current build.** Increment 2; unit U4 of the tools-as-skills record. The 57% that U4 measured predates U13 and U16 | Grant U4, copied in "Increment 2" below; targets named by David at 2026-09-23T04:19:06Z: `findmynextbite.food` (live, held) and its build directory | Moss (worker-U4 subagent), since "2026-09-22T22:23:04-06:00" | As Grant U4, with the acceptance criteria in the U17 pickup plan. Accepted by Primary | Grant tolerance: 8 hours and 3 failed attempts at any one check |
